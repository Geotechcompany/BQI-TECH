    ...
    try:
        ...
        for job in problematic_jobs:
            try:
                ...
                result = db.jobpostings.update_one(
                    {"_id": job["_id"]},
                    {
                        "$set": {
                            "createdBy": None,
