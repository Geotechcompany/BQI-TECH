        ...
        <div className="max-w-6xl mx-auto px-4 relative">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
              Our comprehensive hiring process is designed to be transparent,
              fair, and focused on finding the right fit for both candidates and
              our team.
            </p>
          </div>
          ...
          >
            <p className="text-gray-600 mb-6">
              Ready to start your journey with us? Check out our current
              openings!
            </p>
            <Button
      ...
      {sections.map((section, index) => (
        ...
        >
          <div className="grid md:grid-cols-2 gap-12 items-center p-12">
            ...
            >
              <h2
                className="text-3xl font-bold bg-gradient-to-r from-[#272055] to-[#31CDFF] 
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <motion.p
            ...
            transition={{ duration: 0.8, delay: 0.4 }}
          >
            Are you ready to take your career to the next level? Explore our
            open positions and become part of a team that's redefining tech
            solutions.
          </motion.p>
          <Button
