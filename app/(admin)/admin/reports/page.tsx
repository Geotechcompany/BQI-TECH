      ...
      {items.map((item) => (
        <li key={item.name} className="space-y-1.5">
          <div className="flex items-center justify-between gap-3 text-sm">
            <Link
              href={publicAdminHref(`/manage/candidates?search=${encodeURIComponent(item.name)}`)}
        ...
        <div className="space-y-5 px-4 md:px-6 pb-6 pt-2 w-full max-w-none">
          ...
          >
            ...
            {selectedJobId === ALL_POSITIONS ? (
              ...
              <Link
                href={publicAdminHref(`/manage/jobs/${selectedJobId}/pipeline`)}
            ...
            <Link href={publicAdminHref("/manage/hired")}className="block group">
