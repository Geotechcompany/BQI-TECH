...
export default function DisqualifiedPage() {
  ...
  if (isLoading) {
    return (
      <AdminPageLayout title="Disqualified Applications" showSearch={false}>
  ...
  if (error) {
    return (
      <AdminPageLayout title="Disqualified Applications" showSearch={false}>
        <div className="text-center text-red-600">Failed to load disqualified applications</div>
      </AdminPageLayout>
    );
  }
  ...
  return (
    <AdminPageLayout
      title="Disqualified Applications"
    ...
    >
      ...
      <div className="mb-4 text-sm text-muted-foreground">
        Showing {applications.length} of {total} disqualified applications
      </div>
