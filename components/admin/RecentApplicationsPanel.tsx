      ...
      <div className="relative border-b border-border/50 px-4 py-3">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-2.5">
            <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-violet-500 to-purple-600 shadow-md shadow-violet-500/25">
          ...
          <Link
            href={viewAllHref}
            className="group inline-flex items-center gap-1.5 rounded-full border border-border/80 bg-background/80 px-3 py-1.5 text-xs font-medium text-foreground shadow-sm transition-all hover:border-violet-500/30 hover:bg-violet-500/5 hover:text-violet-700 dark:hover:text-violet-300"
          >
            View all
      ...
      <div className="relative p-3 md:p-4">
        {items.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-xl border border-dashed border-border/80 bg-muted/20 px-6 py-10 text-center">
            <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-violet-500/10 to-purple-500/10">
            ...
            <Link
              href={viewAllHref}
              className="mt-4 inline-flex items-center gap-2 text-sm font-medium text-violet-600 hover:text-violet-700 dark:text-violet-400"
            >
              Browse applications
            ...
            {items.map((app, index) => {
              ...
              return (
                <motion.button
                  ...
                  onClick={() => onView(app)}
                  className={cn(
                    "group relative w-full overflow-hidden rounded-lg border border-border/50 p-3 text-left",
                ...
                >
                  ...
                  <div className="relative flex gap-2.5">
                    <div
                      className={cn(
                        "flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br text-xs font-bold text-white shadow-md",
