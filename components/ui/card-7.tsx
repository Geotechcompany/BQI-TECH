      ...
      <div className="w-full grid grid-cols-3 gap-4 items-end">
        <div className="col-span-2 flex flex-col justify-end h-full">
          <div className="space-y-2">
            <motion.h2 variants={itemVariants} className="text-xl font-bold leading-tight">{title}</motion.h2>
            <motion.p variants={itemVariants} className="text-sm opacity-80">{author}</motion.p>
          </div>
          <motion.button
        ...
        <motion.div variants={itemVariants} className="col-span-1 flex items-center justify-center">
