...
export const JobPostCard: React.FC<JobPostCardProps> = ({
  ...
  const pipelineHref = hasJobId
    ? publicAdminHref(`/manage/jobs/${jobId}/pipeline`)
    : null;
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-52">
                  <DropdownMenuItem asChild>
                    <Link href={publicAdminHref(`/manage/job-postings/${jobId}/edit`)}>
                      <Pencil className="mr-2 h-4 w-4" />
                      Edit position
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link href={publicAdminHref(`/manage/jobs/${jobId}/pipeline/settings`)}>
                      <Columns3 className="mr-2 h-4 w-4" />
                      Pipeline settings
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link href={publicAdminHref(`/manage/job-postings/${jobId}/wizard`)}>
        ...
        >
          ...
          {pipelineHref && (
            ...
            >
              ...
              <Link
                href={publicAdminHref(`/manage/candidates?jobId=${jobId}`)}
                className="pointer-events-auto text-white underline-offset-2 hover:underline"
                onClick={(event) => event.stopPropagation()}
              >
                Candidates
